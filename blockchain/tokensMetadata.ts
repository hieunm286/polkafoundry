...
const tokens = [
  ...
  },
  {
    ...
    bannerIcon: ('/images/img/banner_icons/bat.svg'),
    tags: [],
  },
  {
    symbol: 'WBTC',
    ...
    bannerIcon: ('/images/img/banner_icons/wbtc.svg'),
    tags: [],
  },
  {
    symbol: 'RENBTC',
    ...
    bannerIcon: ('/images/img/banner_icons/renbtc.svg'),
    tags: [],
  },
  {
    symbol: 'TUSD',
    ...
    bannerIcon: ('/images/img/banner_icons/tusd.svg'),
    tags: ['stablecoin'],
  },
  {
    symbol: 'KNC',
    ...
    bannerIcon: ('/images/img/banner_icons/knc.svg'),
    tags: [],
  },
  {
    symbol: 'MANA',
    ...
    bannerIcon: ('/images/img/banner_icons/mana.svg'),
    tags: [],
  },
  {
    symbol: 'PAXUSD',
    ...
    bannerIcon: ('/images/img/banner_icons/pax.svg'),
    tags: ['stablecoin'],
  },
  {
    symbol: 'USDT',
    ...
    bannerIcon: ('/images/img/banner_icons/usdt.svg'),
    tags: ['stablecoin'],
  },
  {
    symbol: 'COMP',
    ...
    bannerIcon: ('/images/img/banner_icons/comp.svg'),
    tags: [],
  },
  {
    symbol: 'LRC',
    ...
    bannerIcon: ('/images/img/banner_icons/lrc.svg'),
    tags: [],
  },
  {
    symbol: 'LINK',
    ...
    bannerIcon: ('/images/img/banner_icons/link.svg'),
    tags: [],
  },
  {
    symbol: 'GUSD',
    ...
    bannerIcon: ('/images/img/banner_icons/gusd.svg'),
    tags: ['stablecoin'],
  },
  {
    symbol: 'ZRX',
    ...
    color: '#000',
    background: 'linear-gradient(156.14deg, #222121 12.76%, #8E8E8E 93.58%)',
    bannerIcon: ('/images/img/banner_icons/zerox.svg'),
    tags: [],
  },
  {
    symbol: 'USDC',
    ...
    bannerIcon: ('/images/img/banner_icons/usdc.svg'),
    tags: ['stablecoin'],
  },
  {
    symbol: 'BAL',
    ...
    color: '#000',
    background: 'linear-gradient(156.14deg, #222121 12.76%, #8E8E8E 93.58%)',
    bannerIcon: ('/images/img/banner_icons/bal.svg'),
    tags: [],
  },
  {
    symbol: 'YFI',
    ...
    color: '#0657f9',
    background: 'linear-gradient(145.44deg, #0060CD 17.44%, #6AADFA 91.11%)',
    bannerIcon: ('/images/img/banner_icons/yfi.svg'),
    tags: [],
  },
  {
    symbol: 'UNI',
    ...
    bannerIcon: ('/images/img/banner_icons/uni.svg'),
    tags: [],
  },
  {
    symbol: 'AAVE',
    ...
    bannerIcon: ('/images/img/banner_icons/aave.svg'),
    tags: [],
  },
  {
    symbol: 'UNIV2USDCETH',
